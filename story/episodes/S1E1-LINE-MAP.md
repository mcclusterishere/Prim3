...
ai_reader: DO_NOT_USE_AS_CURRENT_LINE AUTHORITY
...
Current framing authority is:

`story/missions/HIGH-ALERT.md`

Current RAID payoff is:

`episodes/S07E01-RAID-HOT-SITE.md`

When a High Alert line is attached to a later episode, remember:
