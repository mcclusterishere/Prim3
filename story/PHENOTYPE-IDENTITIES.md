---
status: CANON
system: Phenotype-to-character identity table
version: 3.0.0
branch: main
---
...
**Phenotype = role in the system. Character = person. Wear = clothing. Episode owner = story perspective.**
...
## McCluster / PRIM operational tree

### Authority

| Phenotype | Primary | Second seat | Character logic |
|---|---|---|---|
| **Authority-01 Executive** | **Helen Clarke** — visible institutional executive face | **Li Wei** | Helen governs the visible institution; Li studies how authority should be auditable. PRIM2 sits above this tree secretly, not as an ordinary org-chart executive. |
| **Authority-02 Director** | **Helen Clarke** | **Li Wei** | Resource/continuity authority versus governance scrutiny. |
| **Authority-03 Mission Sponsor** | **Amira Hassan** | **Marc Dubois** | Amira emphasizes ethical/safety braking; Marc models strategic value and quantified risk. GLASSHOUSE permanently complicates both. |

### Defense

| Phenotype | Primary | Second seat | Character logic |
|---|---|---|---|
| **Defense-01 Building Guard** | **Dmitri Volkov** | **Emre Yıldız** | Disciplined response versus physical-systems/emergency reality. |
| **Defense-02 Access Officer** | **Nusrat Rahman** | **Miguel Santos** | Rule consistency versus humane enforcement. |
| **Defense-03 Tech-Zone Guard** | **Hassan Raza** | **Jonas Weber** | Human boundary protection versus deep automation knowledge. |

### Field triad

| Phenotype | Primary | Second seat | Character logic |
|---|---|---|---|
| **Field-T Technical Operator** | **Aya Shinoda** | **Minh Tran** | Aya is cyber-physical/robotics/safety-state depth; Minh challenges her from hardware/firmware truth. |
| **Field-E Entry Operator** | **Arjun Mehta** | **Sari Wulandari** *(cross-trained)* | Physical access/safety versus adaptive route finding when expected paths fail. |
| **Field-R Overwatch Operator** | **Rafael Costa** | **Oksana Bondarenko** | Live environmental awareness versus forensic/intent reconstruction. |
...
### Support / analysis / public surface

| Function | Primary | Second seat | Character logic |
|---|---|---|---|
| **Cohort support / human consequences** | **Grace Mbala** | **Aisha Diallo** *(external)* | Keeps names and civilian effects attached to decisions. |
| **Authority analysis** | **Leila Hosseini** | **Li Wei** | Security and governance skepticism from different institutional histories. |
| **Public brand / marketing surface** | **Priya Srisawat** | **Maren Quill** | Belonging, recruitment and public narrative versus transparency. |
| **System liaison** | **Jonas Weber** | **Emre Yıldız** | Automation relationship versus physical verification. |

### System

| Phenotype | Identity | Story function |
|---|---|---|
| **System-01 Building Platform** | **Pylon** | Persistent automation character whose relationship with Jonas and hidden PRIM2 integration can make infrastructure behave like institutional personality. |

## Hitman mirrored tree — immediate PRIM3 era

Hitman is a separate street/corporate organism under PRIM2's hidden dual architecture. It does not have a separate contemporary Benji.
...
| **H-Defense-02 — Access / Social Gate** | **Kira “Keys” Moon** | **Rae “Twin” Colton** | Social topology and practical access. |
| **H-Defense-03 — Gear / Logistics** | **Omar “Rack” Dillon** | **Jules “Kiosk” Mendez** | Physical resource reliability and technical favors. |
| **H-Field-T — Deniable Tech** | **Jules “Kiosk” Mendez** | **Kira “Keys” Moon** | Street-facing technical support. |
| **H-Field-E — Social / Entry Asset** | **Rae “Twin” Colton** | **Sora “Gymnast” Okada** *(unknown sibling asset)* | Street/social entry mirrored against elite institutional entry. |
| **H-Field-R — Overwatch** | **Chris “Perch” Alvarez** | **Tone Rivera** | Context and environmental early warning. |
| **H-Cohort-01 — Active Crew** | **Dez “Switch” Calhoun** | **Rae “Twin” Colton** | Adaptable mission-capable operators without full-board knowledge. |
...
This table indicates characters naturally suited to concepts; it does **not** assign mandatory episode ownership.
...
When an episode needs a role, use existing people before inventing a new person. But do not confuse `person suited to lesson` with `episode owner`.
