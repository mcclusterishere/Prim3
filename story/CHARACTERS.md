...
This is the fast index. Specialist files override short summaries where they conflict.
...
| 17 | **Minh Tran** | Vietnam | Field-T | Hardware/firmware skeptic who wants technical truth without becoming somebody else's hands. |
| 18 | **Leila Hosseini** | Iran | Authority analysis | Designs trust while remaining suspicious of institutions that decide who deserves it. |
| 19 | **Emre Yıldız** | Turkey | Defense-01 | Physical-systems realist who keeps cyber operators aware of heat, water, power and gravity. |
| 20 | **Jonas Weber** | Germany | System liaison | Automation engineer increasingly emotionally dependent on Pylon while insisting it is only a tool. |
| 21 | **Priya Srisawat** | Thailand | Marketing / public surface | Built aspirational institutional identity and must confront belonging as behavioral control. |
| 22 | **Helen Clarke** | United Kingdom | Authority-02 Director | Wants governance capable of surviving PRIM2 rather than merely obeying him. |
| 23 | **Marc Dubois** | France | Mission Sponsor | Quantifies risk elegantly until human loss breaks the arithmetic. |
| 24 | **Thandiwe Nkosi** | South Africa | Cohort-03 Lead | Wants enough authority to reform the system without becoming proof that the system was fine. |

These characters are **canon**, not merely proposed names.
...
- **Keiko Shinoda** — Japan; mother; physical therapist; teaches `the patient owns the goal`.
- **Hana Lee** — South Korea; Aya's mentor/friend; robotics engineer and secretly an NIS technical intelligence officer; killed during GLASSHOUSE after approaching the hidden PRIM architecture.
- **Tariq Al-Farsi** — Saudi Arabia; Aya's long-term engineering/aviation-systems friend and reality check.
- **Zayd Al-Harthi** — Oman; Aya's former Yale partner; relationship fails because care becomes supervision, not betrayal.

See:
- `AYA-SHINODA-PSYCHOLOGICAL-BACKGROUND.md`
- `HANA-LEE-PSYCHOLOGICAL-BACKGROUND.md`
- `REN-SHINODA-PSYCHOLOGICAL-BACKGROUND.md`
- `AYA-CIRCLE-RELATIONSHIP-WEB.md`
- `AYA-HANA-INTELLIGENCE-CANON.md`
- `AYA-HANA-KKEUTORI-BREADCRUMB-CANON.md`
- `AYA-HANA-KKEUTORI-JOKE-ARCHIVE.md`

## Public / system recurring
...
Their non-conflicting characterization in `HITMAN-CAST.md` and `IMMEDIATE-CAST-CANON.md` is canon.

## Attached multinational network

The 48 Legacy/Freelancer characters in `CAST-NATIONS.md` are canon supporting relationships around the 24 mains.

They are not mandatory exposition. They exist to ensure every major person has grief, favors, outside work, old friendships, family-like relationships and moral reference points beyond the central institution.
...
| Amira ↔ Marc | GLASSHOUSE: stop versus continue, both acting on an incomplete information environment shaped by PRIM2. |
| Emre ↔ Jonas ↔ Pylon | Human procedure versus automation versus institutional intelligence. |
| Rae ↔ Sora | Unknown operational twins serving the same apex from opposite social worlds. |

## Character standard

Every recurring character must have **competence, desire, fear, contradiction, failure mode, ordinary life, outside connection, history-derived decision logic and at least one relationship capable of hurting them without requiring physical danger**.
