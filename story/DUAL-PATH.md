...
system: PRIM / Hitman dual-board relationship
version: 2.0.0
branch: main
---

# Dual board — PRIM and Hitman

PRIM and Hitman are separate operational cultures that PRIM2 can observe and influence from a higher hidden authority layer.
...
Their people have independent wants, loyalties and histories. PRIM2's dual-board advantage comes from seeing context across compartments that ordinary participants cannot.

PRIM2 does **not** need to manufacture every conflict or casualty for the architecture to matter.

Current apex relationships:
