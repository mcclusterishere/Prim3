...
- `CANON.md` — root authority, now including ensemble/Wildcard/Apex/Royce law
...
The 24 multinational PRIM/McCluster mains and 48 attached Legacy/Freelancer relationships are **canon**, subject to deliberate future revision.

`story/CAST-NATIONS.md` remains the large multinational source roster, while specialist dossiers override older short summaries where they conflict.
...
The sweep rewrote or retired the high-risk stale authorities around:
- Wildcard/Apex/Royce escalation;
- finale survivor identity;
- High Alert framing;
- Evil Twin purpose;
- Ghost succession;
- Hitman contemporary leadership;
- longform/progression assumptions;
- legacy PRIM-N1 asset naming;
- episode-authoring template and index.
