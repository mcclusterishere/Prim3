---
status: CANON-MIGRATION-AUDIT
system: 21-episode living-cast / owner / continuity audit
version: 1.0.0
branch: main
---

# PRIM3 — Living-Cast Episode Migration Audit

## Purpose

This audit records the September 10, 2026 review of **every canonical episode file** against the current ensemble, PRIM, Wildcard, character-lifecycle and reverse-reveal authorities.

It does **not** rewrite Episodes 01–18. It tells the next rewrite pass what material can be preserved and what character/story assumptions are stale.
...
- `story/HUMAN-STORY-ENGINE.md`
- `game/WILDCARD-INTERVENTION-AUTHORITY.md`
- `episodes/CHAPTER-TEMPLATE.md`

Canonical rewrite law:

> **Preserve strong incidents. Replace stale character architecture.**
...
### CURRENT
Core chronology/ownership is consistent with present canon. Add scene-level living-cast development during production.

### PARTIAL MIGRATION
Technical incident and substantial character material remain usable, but ownership, recurring cast, micro-development or intervention fields need deliberate revision.
...
**Local file:** `S01E01-THE-BLIP.md`  
**Classification:** **SEVERE STALE CONTINUITY**

### Preserve
- future-RAID cold open;
- 17 memory-anchor concept;
- weak-signal / anomaly / alert-triage learning language if useful;
- college/corporate environment as possible post-rewind ordinary-life material.
...
### Current owners
**Oksana Bondarenko + Rafael Costa**.
...
**Classification:** **PARTIAL MIGRATION / CLOSE TO CURRENT**

### Preserve
- public event / false-belonging social-access incident;
- Priya confronting consequences of frictionless brand design;
- Nusrat/Miguel access response;
- Rae/Sora/Keys opposing-board social-access language.

### Current owners
**Priya Srisawat + Sora “Gymnast” Okada**.
...
**Classification:** **PARTIAL MIGRATION — HIGH-VALUE ATTRITION EPISODE**

### Preserve
- severe-weather communication failure;
- signal strength versus usable service;
- backhaul / power / physical-safety dependency;
- technical service restored while a person is lost;
- canonical line: **The network comes back. The person does not.**

### Current owners
**Sari Wulandari + Yonas Bekele**.

### Critical migration
The local `older cohort veteran` must **not remain an unnamed disposable casualty**.

Before Episode 06 is rewritten, select an **existing recurring roster character** whose prior Episodes 01–05 have deliberately made them lovable/useful enough that the loss matters.

The death must write:
- vacancy;
- workload redistribution;
- changed mission composition;
- grief differences;
- altered routines;
- possible support-character promotion;
...
### Current recurrence
Grace, Helen, Amira, Chioma, Sable, Rae; Royce conditional.

### Rewrite job
Turn the same breach into a governance/identity episode in which Grace remains vital but Leila/Li carry the deepest institutional change.
...
### Preserve
- unsafe/contradictory application state;
- input validation, privilege boundary, reduced-function fallback, safe failure;
...
### Preserve
- symptom classification rather than one-label thinking;
- containment without witch-hunt logic;
- shame/concealment as human attack surface;
...
### Current recurrence
Hassan, Leila, Chioma, Emre, Dez; Royce conditional.

### Rewrite job
Choose any concealed mistake from the existing roster only if it strengthens these relationships; do not invent a disposable cohort culprit.
...
### Preserve
- clean install vs in-place upgrade vs retirement/migration decision;
- rollback/backup/validation mechanics;
...
### Preserve
- owner-authorized decommissioned-site assessment;
- discarded physical evidence / custody / topology / residual-signal concepts;
...
### Preserve
- smart building with mutually impossible digital/physical states;
- life safety before diagnosis;
- human override / sensor confidence / actuator-state mechanics;
- Jonas + Emre cyber-physical tension;
...
### Preserve
- service-layer dependency/ownership incident;
- `not our layer` institutional failure;
...
- total cost, flexibility, dependency and exit-path mechanics;
- critical control path that cannot be casually outsourced;
...
### Current recurrence
Helen, Priya, Maren, Li, Grace, Grant Voss.

### Rewrite job
Use the same CapEx/OpEx problem to reactivate **GLASSHOUSE**: Marc's cost/risk arithmetic versus Amira's refusal to normalize unverifiable human risk.
...
### Preserve
- international demand spike;
- elasticity, scalability, availability, workload separation, failover, cost;
...
## 18 — SONG #21 / MISSION #18 OPEN
**Classification:** **OPEN SLOT — CONTAINER NEEDS TERMINOLOGY/ENSEMBLE MIGRATION**

### Preserve
- do not invent the missing song;
- bridge function from Episode 17 to RAID;
- verified evidence, not paranoia alone, must justify challenging PRIM2;
...
The assault teams must be composed from **established recurring people**, not faceless extras.

Before final script lock, define:
- who enters on each side;
- each person's final micro-arc / unresolved relationship;
...
The episode should also carry the freshly dead RAID ensemble as active grief/absence, not switch instantly to clean philosophy.

---

## 21 — GHOST IN THE WIRES / LAST PROCESS
**Classification:** **CURRENT CORE / ADD SOCIAL-GRIEF GOVERNANCE LAYER**

Current PRIM2→PRIM3 privilege-reduction/succession structure is correct.
...
# Repo-wide conclusions

## Strong material to preserve

The local drafts contain substantial useful technical/inciting-event work. The migration should **not** erase:
- access authorization in E02;
- evidence/provenance in E03;
- social trust/access in E04;
- role/command exercise in E05;
- communications + physical dependency in E06;
- breach/identity in E07;
- app safe-failure in E08;
- malware classification/shame in E09;
- migration/rollback in E10;
- physical evidence/decommissioning in E11;
- cyber-physical building state in E12;
- shared service responsibility in E13;
- CapEx/OpEx dependency economics in E14;
- cloud elasticity in E15;
- road-kit/human fatigue in E16;
- patch/rollback/trust in E17.

## Stale patterns to remove everywhere
...
- clean one-for-one replacement after death;
- emotional reset after injury/death/promotion;
- faceless RAID assault-team casualties.
...
Rewrite local episodes sequentially using `episodes/CHAPTER-TEMPLATE.md` v2.3:

1. E01 High Alert / The Blip — reacquisition correction + recurring pilot cast.
2. E02 Permission Slip — first full living-cast rewrite.
3. Continue through E18.
4. After each rewrite, update whole-roster A/B/C/D ledger, relationship state, casualty eligibility and later payoff fields.
5. Revisit E19–21 only after the surviving/dead roster entering RAID is actually known from Episodes 02–18.

This audit is the migration checklist for that work.