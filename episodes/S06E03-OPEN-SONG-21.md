---
status: CANON MIGRATED PROTECTED OPEN SLOT
season: 6
episode: 3
global_episode: 18
level_id: LVL-18
song: SONG #21 — OPEN
mission: MISSION #18 — OPEN
...
Do **not** invent Song #21's title, lyrics, technical payload, performer-specific lyric meaning or exact mission mechanic before owner source exists.

The episode's **story function, ensemble ownership and continuity job are locked**.
...
Episode ownership determines depth, not exclusivity. This episode is intentionally crowded because the institutional question now belongs to people who have spent six seasons operating the same system.

---

# Mandatory character writes

| Character | Required development function |
|---|---|
...
| Grace | Keeps the argument tied to the actual people who will live or die under whatever choice the executives make. |

---

# Locked story job

Episode 18 must accomplish all of the following regardless of the eventual song concept:

1. Separate technical trust hierarchy from organizational titles and show that both resolve toward a dangerous hidden root property.
...
This episode must show that six seasons of micro-development accumulated.

Examples of the kind of continuity expected:
- people know who will overclaim and who will demand provenance;
- somebody uses a dead coworker's old phrase or procedure without announcing why;
- staffing gaps and injuries from earlier missions affect who is physically in the room;
- one support character may now be functionally a main because they absorbed work after attrition;
- disagreements occur along relationships the audience has watched develop, not newly invented faction lines.

No one is permitted to reset to their Season One personality for convenience.

---

# Song-dependent fields intentionally open

After Song #21 exists, lock:
- exact technical concept;
- music-film imagery and performer;
- mission environment;
- playable verbs;
