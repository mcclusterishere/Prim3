...
- Target runtime: **approximately 9 minutes per episode**
  1. ~3 minutes — cinematic music film
  2. ~3 minutes — human/character story
  3. ~3 minutes — mission/action sequence
- The mission segment may be **WATCHED** as authored action or **PLAYED** as a gamified version of the same story event.
- Player results may change grade, injuries, exposure, resources, relationship state and debrief details without casually breaking the core season spine.
...
- The human-story segment must create a conflict that matters independently of the lesson.
...
Nine-level Site 0 stack and Prime visual anchors remain locked as previously established: exact M helmet architecture, Dual Sight bars, visible optical camera and Jetson-class Mission Core bay.
