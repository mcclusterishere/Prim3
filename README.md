...
- Seven seasons; one academic year per season.
...
- Canon stored openly and persistently in this repository.

## Current succession canon
...
The immediate PRIM-era cast is governed by:
- `story/IMMEDIATE-CAST-CANON.md`
- `story/CHARACTERS.md`
- `story/ENSEMBLE-POV-AUTHORITY.md`
- `story/CHARACTER-PSYCHOLOGY-DECISION-AUTHORITY.md`
...
Aya Shinoda now has a full psychological/background authority. Hana Lee is her genuine mentor and friend and, unknown to Aya, a South Korean NIS technical intelligence officer investigating McCluster's hidden authority architecture.

Hana reaches the `Living Root` hypothesis with support from her agency, realizes somebody above the visible organization is learning from her investigation, and leaves Aya a delayed breadcrumb path inside the Japanese/Korean word-chain game they turned into their private **Kkeutori** variant.
...
## Current song / episode status

- 20 owner-supplied songs are preserved under `source-material/`.
- Global Episode 18 remains protected for owner-supplied Song #21.
- The episode spine remains 21 total episodes.
- The story may shift emotional POV independently from mission lead or playable POV.

## Repository map

- `episodes/` — expandable episode/playable-level chapters
- `story/` — canon, progression, mission bible, cast, psychology and state
- `source-material/` — preserved owner lyrics and supplied media packages
- `characters/` — visual/role anchors; legacy filenames may remain as compatibility stubs
- `production/` — AI-assisted production rules and manifests

The repository is the source of truth. Conversation ideas become canon when recorded or explicitly superseded here.

## Ownership

Created by Matthew McCluster / McCluster. All story and brand rights reserved unless a file states otherwise.
